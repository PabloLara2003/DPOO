...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pais de origen de un atleta");
	...
	/**
	 * Le pide el usuario el nombre de un atleta y luego le muestra el
	 *  pais de origen.
	 */
	private void ejecutarPaisPorAtleta() {
        String atleta = input("Ingrese el nombre del atleta ");
        if (atleta == null) {
            System.out.println("El input no fue reconocido apropiada mente intente de nuevo\n");
            ejecutarPaisPorAtleta();
        }
        Atleta atletaInfo = calculadora.paisDeOrigen(atleta);
        if (atletaInfo != null)
            System.out.println("El atleta " + atletaInfo.darNombre() + " tiene como pais de origen: " + atletaInfo.darPais().darNombre());
        else
            System.out.println("El atleta " + atleta + "' no se ha encontrado ");
    }
